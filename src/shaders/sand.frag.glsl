...
void main() {
  ...
  float dark = mix(1.0, 0.38, wet);
  albedo *= dark;
  albedo = mix(albedo, albedo * vec3(0.7, 0.66, 0.56), wet * 0.5);
  albedo = mix(albedo, albedo * vec3(0.78, 0.82, 0.8), smoothstep(0.001, 0.02, water) * 0.25);
