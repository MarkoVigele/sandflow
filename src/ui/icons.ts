export const ICONS: Record<string, string> = {
  ...
  tamp: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 4h8v5H8z" fill="none" stroke="currentColor" stroke-width="1.6"/><path d="M6 20h12M8 9l-2 7h12l-2-7" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/></svg>`,
  groove: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 6c2 3 3 3 5 0s4-3 6 1 3 4 3 7" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/><path d="M7 18c2-2.4 4-2.2 5 .2 1.4 2.4 3.2 2.6 5 .2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
  flatten: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 14h16" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M7 10 12 6l5 4M7 18l5 4 5-4" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
